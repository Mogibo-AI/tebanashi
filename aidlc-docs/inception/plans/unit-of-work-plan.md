...
- [ ] すべての `[Answer]:` が空でないことを確認する
- [ ] 複数案の混在がある場合、どの条件で使い分けるかを確認する
- [ ] 未定義の用語がある場合、フォローアップ質問を追加する
- [ ] 依存順序とユニット境界が矛盾していないか確認する
- [ ] 全ストーリーが割り当て可能か確認する
- [ ] Greenfield コード構成方針が生成成果物に反映可能か確認する
- [ ] 計画承認プロンプトを提示する
...
この計画の `[Answer]:` がすべて埋まるまで、次の成果物は生成しない。
